...
```sh
helm upgrade --install -n dev --create-namespace --set postgres.terminationGracePeriodSeconds=10 --version 0.1.0 postgres-rclone oci://ghcr.io/sfmunoz/postgres-rclone
```
